...
<?php 
    ...
    $user_id = (isset($_GET['id']) && $_GET['id'] != '' ) ? intval( $_GET['id'] ) : 1;
                    ...
                    <div class="nbd-user-info">
                        ...
                        <div class="nbd-designer-info">
                            ...
                            <div class="nbd-social-list">
                                ...
                                <a class="nbd-social" href="<?php echo $user_infos['nbd_artist_youtube']; ?>" title="<?php _e('Linkedin', 'web-to-print-online-designer'); ?>">
