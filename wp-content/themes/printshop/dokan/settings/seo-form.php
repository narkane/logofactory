...
<form method="post" id="dokan-store-seo-form"  action="" class="dokan-form-horizontal">
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-meta-title"><?php _e( 'SEO Title :', 'dokan' ); ?>
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-meta-desc"><?php _e( 'Meta Description :', 'dokan' ); ?>
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-meta-keywords"><?php _e( 'Meta Keywords :', 'dokan' ); ?>
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-og-title"><?php _e( 'Facebook Title :', 'dokan' ); ?></label>
        </div>
        <div class="col-md-9">
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-og-desc"><?php _e( 'Facebook Description :', 'dokan' ); ?></label>
        </div>
        <div class="col-md-9">
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-og-image"><?php _e( 'Facebook Image :', 'dokan' ); ?></label>
        </div>
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-twitter-title"><?php _e( 'Twitter Title :', 'dokan' ); ?></label>
        </div>
        <div class="col-md-9">
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-twitter-desc"><?php _e( 'Twitter Description :', 'dokan' ); ?></label>
        </div>
        <div class="col-md-9">
    ...
    <div class="row form-group">
        <div class="col-md-3">
            <label for="dokan-seo-twitter-image"><?php _e( 'Twitter Image :', 'dokan' ); ?></label>
        </div>
        <div class="col-md-9 dokan-gravatar dokan-seo-image">
    ...
    <div class="row form-group dokan-group-button">
        ...
        <div class="col-md-9">
            <input type="submit" id='dokan-store-seo-form-submit' class="dokan-left dokan-btn dokan-btn-danger" value="<?php esc_attr_e( 'Save Changes', 'dokan' ); ?>">
        </div>
