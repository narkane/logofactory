...
<div class="row dokan-address-fieldz form-group">
    <div class="col-md-3">
        <label><?php _e( 'Address', 'dokan' ); ?></label>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label for="pwd"><?php _e( 'Street ', 'dokan' ); ?>
                        <?php
                        $required_attr = '';
                ...
                if ( $seller_address_fields['city'] || $seller_address_fields['zip'] ) {?>
                    ...
                    if ( $seller_address_fields['zip'] ) { ?>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php _e( 'Post/ZIP Code', 'dokan' ); ?>
                                    <?php
                                    $required_attr = '';
