...
<div class="order_download_permissions wc-metaboxes-wrapper">
    ...
    <div class="toolbar row dokan-clearfix">
        ...
        <div class="dokan-w4">
            <button type="button" class="dokan-btn dokan-btn-success grant_access" data-order-id="<?php echo $order->get_id(); ?>" data-nonce="<?php echo wp_create_nonce( 'grant-access' ); ?>"><?php _e( 'Grant Access', 'dokan' ); ?></button>
        </div>
