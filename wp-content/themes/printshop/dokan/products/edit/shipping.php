...
<div class="dokan-form-horizontal dokan-product-shipping">
    ...
    <?php if ( 'yes' == get_option( 'woocommerce_calc_shipping' ) ): ?>
        <div class="row form-group">
            <div class="col-md-3"><label><?php _e( 'Disable Shipping', 'dokan' ); ?></label></div>
            <div class="col-md-9">
    ...
    <div class="row form-group">
            <div class="col-md-3"><label><?php echo __( 'Weight', 'dokan' ) . ' (' . get_option( 'woocommerce_weight_unit' ) . ')'; ?></label></div>
            <div class="col-md-9">
    ...
    <div class="row form-group">
            <div class="col-md-3"><label><?php echo __( 'Dimensions', 'dokan' ) . ' (' . get_option( 'woocommerce_dimension_unit' ) . ')'; ?></label></div>
    ...
    <?php if ( 'yes' == get_option( 'woocommerce_calc_shipping' ) ): ?>
        <div class="row form-group hide_if_disable">
            <div class="col-md-3"><label><?php _e( 'Override Shipping', 'dokan' ); ?></label></div>
            <div class="col-md-9">
        ...
        <div class="row form-group dokan-shipping-price dokan-shipping-type-price show_if_override hide_if_disable">
            <div class="col-md-3"><label><?php _e( 'Additional cost', 'dokan' ); ?></label></div>
            <div class="col-md-9">
       ...
       <div class="row form-group dokan-shipping-price dokan-shipping-add-qty show_if_override hide_if_disable">
            <div class="col-md-3"><label><?php _e( 'Per Qty Additional Price', 'dokan' ); ?></label></div>
            <div class="col-md-9">
        ...
        <div class="row form-group dokan-shipping-price dokan-shipping-add-qty show_if_override hide_if_disable">
            <div class="col-md-3"><label><?php _e( 'Processing Time', 'dokan' ); ?></label></div>
            <div class="col-md-9">
