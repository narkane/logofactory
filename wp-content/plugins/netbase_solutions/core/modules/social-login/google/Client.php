...
require_once NBTSL_PLUGIN_DIR.'google/Auth/AssertionCredentials.php';
require_once NBTSL_PLUGIN_DIR.'google/Cache/File.php';
require_once NBTSL_PLUGIN_DIR.'google/Cache/Memcache.php';
require_once NBTSL_PLUGIN_DIR.'google/Config.php';
require_once NBTSL_PLUGIN_DIR.'google/Collection.php';
require_once NBTSL_PLUGIN_DIR.'google/Exception.php';
require_once NBTSL_PLUGIN_DIR.'google/IO/Curl.php';
require_once NBTSL_PLUGIN_DIR.'google/IO/Stream.php';
require_once NBTSL_PLUGIN_DIR.'google/Model.php';
require_once NBTSL_PLUGIN_DIR.'google/Service.php';
require_once NBTSL_PLUGIN_DIR.'google/Service/Resource.php';
