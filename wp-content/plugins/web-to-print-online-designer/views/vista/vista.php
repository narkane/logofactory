...
<div id="nbd-vista-app" class="nbd-mode-vista <?php echo wp_is_mobile() ? 'nbd-mobile' : 'nbd-desktop'; ?> <?php echo (is_rtl()) ? 'nbd-rtl' : ''?> <?php if(isset($_GET['nbdv-task']) && $_GET['nbdv-task'] != '') echo '1nbd-on-task'; ?>">
