<div class="toolbar-text" ng-show="stages[currentStage].states.isText">
    <ul class="nbd-main-menu menu-left">
        ...
        <li class="menu-item item-font-size" ng-if="settings.nbdesigner_text_font_size == 1" ng-click="updateScrollBar('#toolbar-font-size-dropdown')">
            <div class="toolbar-bottom">
                ...
                <span style="font-size: 11px; margin-left: 5px;text-transform: lowercase;">pt</span><i class="icon-nbd icon-nbd-dropdown-arrows"></i>
                <div class="sub-menu" data-pos="left">
        ...
        <li class="menu-item item-align item-edit-text">
            <i class="icon-nbd icon-nbd-text-fields nbd-tooltip-hover" title="<?php _e('Edit Text','web-to-print-online-designer'); ?>"></i>
            <div class="sub-menu" data-pos="center" style="min-width: 250px; padding: 30px 10px 15px">
                <div class="box-curved" style="margin-bottom: 20px">
                    <textarea ng-change="setTextAttribute('text', stages[currentStage].states.text.text)" ng-model="stages[currentStage].states.text.text" style="width: 100%; font-size: 12px; padding: 5px; border-radius: 2px" placeholder="<?php _e('Enter your text','web-to-print-online-designer'); ?>"></textarea>
                </div>
            </div>
        </li>
    </ul>
    ...
    <ul class="nbd-main-menu menu-right">
            ...
            <div class="sub-menu" data-pos="center">
                <div class="main-ranges" style="padding: 30px 10px 15px">
                    <div class="range range-line-height">
                        ...
                        <span cattr="text.stroke" color="{{stages[currentStage].states.text.stroke}}" style="vertical-align: middle;" class="nbd-color-picker-preview nbd-color-picker" ng-style="{'background': stages[currentStage].states.text.stroke}"></span>
                        <span style="font-size: 12px; padding: 0 8px; line-height: 24px; height: 24px; display: inline-block; border: 1px solid #ddd;box-sizing: content-box;border-radius: 4px;margin-left: 5px;text-transform: lowercase;">{{stages[currentStage].states.text.stroke}}</span>
                    </div>           
        ...
        <li class="menu-item nbd-color-picker" ng-if="settings.nbdesigner_text_background == 1" cattr="text.textBackgroundColor">
            <i class="icon-nbd nbd-tooltip-hover" title="<?php _e('Background','web-to-print-online-designer'); ?>">
        ...
        <li  ng-if="stages[currentStage].states.type == 'curvedText'"  ng-class="stages[currentStage].states.type == 'curvedText' && curvedText.active ? 'active' : ''" class="menu-item item-curved nbd-tooltop-hover" data-range="true" title="<?php _e('Curved Text','web-to-print-online-designer'); ?>">
            <i ng-click="curvedText.active = !curvedText.active" class="icon-nbd icon-nbd-vector" style="font-size: 18px"></i>
            <div class="sub-menu" data-pos="center" style="min-width: 250px; padding: 30px 10px 15px">
                ...
                <div class="main-ranges">
                    <div class="range range-radius">
                        <label for="" style="text-align: left"><?php _e('Radius','web-to-print-online-designer'); ?></label>
                        <div class="main-track">
                    ...
                    <div class="range range-spacing">
                        <label for="" style="text-align: left"><?php _e('Spacing','web-to-print-online-designer'); ?></label>
                        <div class="main-track">
                ...
                <div class="box-curved-reverse">
                    <span style="font-size: 12px;"><?php _e('Reverse','web-to-print-online-designer'); ?></span>
                    ...
                    <span style="font-size: 12px;margin-left: 15px;"><?php _e('RTL','web-to-print-online-designer'); ?></span>
                    <div class="nbd-checkbox-group">
