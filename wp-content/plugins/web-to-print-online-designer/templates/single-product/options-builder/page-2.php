...
<tr class="nbd-option-field nbd-field-checkbox-wrap <?php echo $class; ?>" ng-if="nbd_fields['<?php echo $field['id']; ?>'].enable">
    ...
    <td class="nbd-field-content nbo-checkbox-wrap">
        ...
        <label ng-class="(nbd_fields['<?php echo $field['id']; ?>'].values.length == 1 && nbd_fields['<?php echo $field['id']; ?>']._values['<?php echo $key; ?>']) ? 'nbo-prevent-pointer' : ''" class="nbo-checkbox" for='nbd-field-<?php echo $field['id'].'-'.$key; ?>'
