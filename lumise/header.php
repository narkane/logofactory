...
<header class="header">
    <div class="container">
        <a href="<?php echo $lumise->cfg->url; ?>" class="logo">
            <img src="/lumise/wp-content/uploads/2019/07/logo.png" alt="Big Bang Printing Product Designer online tool">
        </a>
        <div class="menu">
        ...
        <div class="menu_mobile">
            <a href="<?php echo $lumise->cfg->url; ?>" class="logo_mobile"><img src="/wp-content/uploads/2019/07/logo.png" alt=""></a>
