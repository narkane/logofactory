<div  ng-show="stages[currentStage].states.isGroup" class="toolbar-group">
    <ul class="nbd-main-menu">    
        <li ng-click="groupLayers()" class="menu-item menu-group" ng-show="stages[currentStage].states.isGroup">
            <i class=" tooltipstered nbd-tooltip-hover" title="<?php _e('Group layers','web-to-print-online-designer'); ?>"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="23" height="20" viewBox="0 0 23 20">
                <title><?php _e('Group layers','web-to-print-online-designer'); ?></title>
