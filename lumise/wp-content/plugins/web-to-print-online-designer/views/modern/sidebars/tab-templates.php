<div class="tab tab-first <?php if( $active_template ) echo 'active'; ?>" id="tab-product-template"  nbd-scroll="scrollLoadMore(container, type)" data-container="#tab-product-template" data-type="globalTemplate" data-offset="30">
                ...
                <div class="main-items">
                    <div class="items" style="text-align: left; padding-left: 5px; padding-right: 5px;">                       
                        <div ng-style="{'display': settings.task == 'create_template' ? 'none' : 'inline-block' }" class="item" ng-repeat="temp in resource.templates" ng-click="insertTemplate(false, temp)">
                            <div class="main-item">
                                <div class="item-img" nbd-template-hover="{{$index}}">
...
<div class="nbd-tooltip_templates">
    <div id="tooltip_content_{{$index}}" ng-repeat="temp in resource.templates" class="nbd-perfect-scroll nbd-tooltip-template" nbd-perfect-scroll>
        <div style="padding: 15px;">
            <div class="nbd-img-container text-center {{$last ? 'nbd-img-last' : ''}}" ng-if="stages[$index]" ng-repeat="img in temp.src">
