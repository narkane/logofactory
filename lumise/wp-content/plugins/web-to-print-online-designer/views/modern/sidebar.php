<div class="nbd-sidebar">
    <?php
        ...
        $active_typos = (!$active_product && !$active_design && $product_data["option"]['admindesign'] == "0" && $settings["nbdesigner_enable_text"] == "yes") ? true : false;
        ...
        $show_elements_tab = (!$active_product && !$active_design && !($settings["nbdesigner_enable_clipart"] == "yes" || $settings["nbdesigner_enable_qrcode"] == "yes" || $settings["nbdesigner_enable_draw"] == "yes") || $settings["nbdesigner_hide_element_tab"] == "yes" ) ? false: true;
