...
<div id="nbdesiger-tiny-mce-dialog-template" tabindex="-1" action="" title="" style="display: none; ">
    ...
    <div id="nbdesigner-limit-template" class="nbdesign-shortcode-row">
        <label for="nbdesigner-shortcode-row"><?php echo _e('Template Limit', 'web-to-print-online-designer'); ?></label>
...
<!--    </div>-->
    <div class="nbdesign-shortcode-row">
        <button class="button-primary" id="nbdesigner-shortcode-template-create"><?php echo _e('Create', 'web-to-print-online-designer'); ?></button>
    </div>
</div>