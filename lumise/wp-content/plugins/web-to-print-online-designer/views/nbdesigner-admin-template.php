...
<div class="wrap">
    ...
    <div class="wrap">
        ...
        <div id="nbd-<?php echo $pid; ?>" style="display:none;">
            ...
            <p style="text-align: center;"><a class="button button-primary nbd-create" href="<?php echo $link_add_template; ?><?php echo '&variation_id=0';  ?>" data-href="<?php echo $link_add_template; ?>"><?php echo __("Create template", 'web-to-print-online-designer'); ?></a></p>
        </div>        
        <?php endif; ?>        
        <div id="poststuff">
