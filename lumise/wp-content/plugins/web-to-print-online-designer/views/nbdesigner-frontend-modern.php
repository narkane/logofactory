...
<!DOCTYPE html>
<?php 
    global $is_IE, $nbd_printing_options;
    if($is_IE){
...
<?php
    ...
    if( !is_nbd_product($product_id) ){
//        echo sprintf('<p>%s, <a href="%s">%s</a></p>', 
//                __('No product has been selected or the product is not available for custom design.', 'web-to-print-online-designer'),
//                esc_url( home_url( '/' ) ),
                ...
                <div class="container-fluid" id="designer-controller">
                    ...
                    <div class="nbd-workspace">
                        ...
                        <div class="main <?php echo (wp_is_mobile()) ? 'active' : ''; ?>">
                            ...
                            <?php if( $show_nbo_option && nbdesigner_get_option('nbdesigner_display_product_option') == '2' && !wp_is_mobile() ) include 'modern/await-for-print-options.php'; ?>
                        </div>
