...
<div class="nbd-option-field nbd-field-input-wrap <?php echo $class; ?>" ng-if="nbd_fields['<?php echo $field['id']; ?>'].enable">
    ...
    <div class="nbd-field-content">
        <input 
            ...
            string-to-number type="number" min="<?php echo $field['general']['input_option']['min']; ?>" max="<?php echo $field['general']['input_option']['max']; ?>" step="<?php echo $field['general']['input_option']['step']; ?>" ng-step="0.0001"
            <?php elseif( $field['general']['input_type'] == 'r' ): ?>
            string-to-number type="range" min="<?php echo $field['general']['input_option']['min']; ?>" max="<?php echo $field['general']['input_option']['max']; ?>" step="<?php echo $field['general']['input_option']['step']; ?>" ng-step="0.0001"
        ...
        <span style="display: inline-block; margin-bottom: 5px;">
            ...
            <span class="nbo-dimension-wrap">
                ...
                <input class="nbo-dimension" 
                    ...
                    step="<?php echo $field['general']['step_width']; ?>" <?php if(isset($field['general']['default_width']) && $field['general']['default_width'] != '') echo 'value="' . $field['general']['default_width'] . '" ng-init="nbd_fields['. "'" . $field['id']. "'" .'].width = '. $field['general']['default_width'] .'"'; ?> ng-step="0.0001" />
        ...
        <span style="display: inline-block; margin-bottom: 5px;">
            ...
            <span class="nbo-dimension-wrap">
                ...
                <input class="nbo-dimension" 
                    ...
                    max="<?php echo $field['general']['max_height']; ?>" step="<?php echo $field['general']['step_height']; ?>" <?php if(isset($field['general']['default_height']) && $field['general']['default_height'] != '') echo 'value="' . $field['general']['default_height'] . '" ng-init="nbd_fields['. "'" . $field['id']. "'" .'].height = '. $field['general']['default_height'] .'"'; ?> ng-step="0.0001" />
                <span class="nbo-updown-dimension" nbo-click-debounce ng-click="update_dimension('<?php echo $field['id']; ?>', 'height', 'plus')">+</span>
            </span>
        </span>&nbsp;
        <span class="nbo-dimension-unit"><?php echo nbdesigner_get_option('nbdesigner_dimensions_unit'); ?></span>
