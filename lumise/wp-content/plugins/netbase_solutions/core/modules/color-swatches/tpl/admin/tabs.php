...
<script id="msg-js" type="text/template">
	<div id="message" class="inline notice woocommerce-message" style="margin: 15px 20px;">
		<p><?php _e( 'Before you can use Color Swatch (NB Solution), you need add minimum of two variation attributes on the <strong>Attributes</strong> tab.', 'nbt-solution' ); ?></p>
