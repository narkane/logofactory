...
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    ...
    <form method="post" id="store-form"  action="">
        ...
        <div class="row form-group">
            <div class="col-md-3">
                <label><?php _e( 'Profile Picture', 'dokan' ); ?></label>
            </div>
            <div class="col-md-9">
        ...
        <div class="row form-group">
            <div class="col-md-3">
                <label><?php _e( 'Store Name', 'dokan' ); ?></label>
            </div>
            <div class="col-md-9">
        ...
        <div class="row form-group">
            <div class="col-md-3">
                <label><?php _e( 'Store Product Per Page', 'dokan' ); ?></label>
            </div>
            <div class="col-md-9">
        ...
        <div class="row form-group">
            <div class="col-md-3">
                <label><?php _e( 'Phone No', 'dokan' ); ?></label>
            </div>
        ...
        <?php if ( ! is_int( key( $is_enable_op_discount ) ) && array_key_exists("order-discount", $is_enable_op_discount ) == "order-discount" ) : ?>
            <div class="dokan-form-group">
                <label><?php _e( 'Discount ', 'dokan' ); ?></label>
        ...
        <div class="row form-group group-checkbox">
            <div class="col-md-3">
                <label><?php _e( 'Email', 'dokan' ); ?></label>
            </div>
            <div class="col-md-9">
                <div class="checkbox">
                    <label>
        ...
        <div class="row form-group group-checkbox-last">
            <div class="col-md-3">
                <label><?php _e( 'More product', 'dokan' ); ?></label>
            </div>
            <div class="col-md-9">
                <div class="checkbox">
                    <label>
            ...
            <div class="col-md-9">
                ...
                <div class="dokan-map-wrap">
                    <div class="dokan-map-search-bar">
                        <input id="dokan-map-add" type="text" class="dokan-map-search dokan-form-control" value="<?php echo $map_address; ?>" name="find_address" placeholder="<?php _e( 'Type an address to find', 'dokan' ); ?>" size="30" />
        ...
        <div class="row form-group group-checkbox-terms">
            <div class="col-md-3">
                <label><?php _e( 'Terms and Conditions', 'dokan' ); ?></label>
            </div>
            <div class="col-md-9">
        ...
        <div class="row form-group" id="dokan_tnc_text">
            <div class="col-md-3">
                <label><?php _e( 'TOC Details', 'dokan' ); ?></label>
            </div>
            <div class="col-md-9">
                <?php
                    $settings = array(
