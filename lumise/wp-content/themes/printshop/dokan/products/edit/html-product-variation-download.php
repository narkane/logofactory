<tr>
	<td class="file_name"><input type="text" class="dokan-form-control wc_variation_file_name" placeholder="<?php esc_attr_e( 'File Name', 'dokan' ); ?>" name="_wc_variation_file_names[<?php echo $variation_id; ?>][]" value="<?php echo esc_attr( $file['name'] ); ?>" /></td>
