...
class Netbase_Dokan{
    ...
    function ajax_search_store() {
        ...
        if($rs){
                        ...
                        <div class="dokan-store-banner-wrap">
                            <a href="'. $store_url .'">';
                                if ( $banner_id ) {
                                    ...
                                    $_html .= '<img class="dokan-store-img" src="'. dokan_get_no_seller_image() .'" alt="'. __( 'No Image', 'dokan' ) .'">';
                                }
                            $_html .= '
                            </a>
                            ...
                            <div class="dokan-overlay-profile">
                                <a class="dokan-btn dokan-btn-theme" href="'. $store_url. '">'. __( 'Visit Store', 'dokan' ) .'</a>
                            </div>
                        </div>
                            ...
                            <ul>
                                ...
                                <li>';
                                    if ( isset( $store_info['phone'] ) && !empty( $store_info['phone'] ) ) {
                                        ...
                                        <span title="'. __( 'Phone Number', 'dokan' ) .'">'. esc_html( $store_info['phone'] ) .'</span>';
                                    }
                                $_html .= '
                                </li>
                            </ul>
            ...
            $_html = __( 'No vendor found!', 'dokan' );;
        }
    ...
    function bh_woocommerce_product_get_rating_html($rating_html, $rating){
        $rating_html  = '<div class="rating-wrap" title="' . sprintf( __( 'Rated %s out of 5', 'woocommerce' ), $rating ) . '">';
...
function add_wrap_container_before(){
    ...
    if ( $post_id ) {
        ...
        $return .= __('Dashboard', 'tshirt');

        $return .= '</h1>

<div class="breadcrumbs">			
                <span>'. __('You are here', 'wpnetbase') . ':</span>
...
echo '<div class="page-title-wrap">
				...
				<a property="item" typeof="WebPage" title="Go to ." href="http://192.168.9.111/wpdemo/teepro" class="home"><span property="name">'. get_bloginfo('name') .'</span></a><meta property="position" content="1"></span> &gt; <span property="itemListElement" typeof="ListItem">
...
function dokan_dashboard_nav_edit( $active_menu = '' ) {
    ...
    $menu .= '<li class="dokan-common-links dokan-clearfix"><a title="' . __( 'Visit Store', 'dokan' ) . '" class="tips" data-placement="top" href="' . dokan_get_store_url( get_current_user_id()) .'" target="_blank"><i class="fa fa-external-link"></i> ' . __( 'Visit Store', 'dokan' ) . '</a></li>
            <li class="dokan-common-links dokan-clearfix"><a title="' . __( 'Edit Account', 'dokan' ) . '" class="tips" data-placement="top" href="' . dokan_get_navigation_url( 'edit-account' ) . '"><i class="fa fa-user"></i> ' . __( 'Edit Account', 'dokan' ) . '</a>
            <li class="dokan-common-links dokan-clearfix"><a title="' . __( 'Log out', 'dokan' ) . '" class="tips" data-placement="top" href="' . wp_logout_url( home_url() ) . '"><i class="fa fa-power-off"></i> ' . __( 'Log out', 'dokan' ) . '</a></li>';
...
add_filter('dokan_get_seller_address', 'get_dokan_get_seller_address', 10, 1);
