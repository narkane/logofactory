				...
				<div class="header-right-cart-search">
					<span id="netbase-responsive-toggle"><i class="fa fa-bars"></i></span>
						<div class="header-cart-search">
							...
							<a class="cart-contents" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_html_e( 'View your shopping cart', 'wpnetbase' ); ?>"><span><?php if ( $count > 0 ) echo intval($count) ; ?></span></a>
							<?php } ?>
					...
					<div class="header-right-wrap-top">
						...
						<div class="nbt-main-menu">
							<div class="netbase-menu-title">
								<h3><?php esc_html_e('Navigation','wpnetbase'); ?></h3>
			...
			<div class="header-left-bottom">
				...
				<div class="copy_text">
					...
					if ( printshop_get_option('footer_copyright') == '' ) {
						printf( esc_html__( 'Central - Copyright &copy; 2015 %2$s. All Rights Reserved', 'wpnetbase' ), get_bloginfo('name'), '<a href="'. esc_url( esc_html__( 'http://www.netbaseteam.com/', 'wpnetbase' ) ) .'">netbaseteam.com</a>' );
					} else {
