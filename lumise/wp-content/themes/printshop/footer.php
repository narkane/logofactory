			...
			<div class="container">
				...
				<div class="copy_text col-md-10 padding-left-0 padding-right-0 col-xs-12">
					...
					if ( printshop_get_option('footer_copyright') == '' ) {
						printf( esc_html__( '%s - Copyright &copy; %u %s. All Rights Reserved', 'wpnetbase' ),get_bloginfo( 'description' ), date( 'Y' ), '<a href="'. esc_url( esc_html__( 'http://www.netbaseteam.com/', 'wpnetbase' ) ) .'">netbaseteam.com</a>' );
					} else {
