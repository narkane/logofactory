...
class lumise_connector {
    ...
    public function __construct() {
        ...
        $this->config = array(
            ...
            "upload_path" => '/var/www/bigbangprinting.com/lumise/installer/data/',
			"upload_url" => 'http://127.0.0.1/lumise/installer/data/',
	...
	public function update() {
		...
		if (!empty($connector_content)) {
			...
			$connector_content = str_replace(array(
				'/var/www/bigbangprinting.com/lumise/installer/data/',
				'http://127.0.0.1/lumise/installer/data/',
				'localhost',
                'root',
                'password',
                'bbp',
